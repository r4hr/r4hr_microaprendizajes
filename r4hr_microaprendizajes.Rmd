...
texto en gráficos etiquetas largas nombres de los bloques
...
Ahora veamos cómo se ven las preguntas si intentamos hacer un ranking.
...
Esto es un *work-in-progress* y tengo que agradecer a [Mónica Alonso](https://twitter.com/MonicaLA2000) de RLaies Buenos Aires por la ayuda.
